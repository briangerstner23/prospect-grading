...
-- green. This function is the other half of that check (DECISIONS §23, §27, §28).
--
...
comment on function public.pb_reconcile_state() is
  'Declared-vs-running facts for scripts/reconcile.ts: active rubric, applied migration names, source liveness (external deliveries only), rule-9 mismatch count. Aggregates only; callable by anon (DECISIONS §28).';
