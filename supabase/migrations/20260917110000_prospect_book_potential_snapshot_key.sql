...
-- run (DECISIONS §42, REPAIR-PLAN item 6). The nightly job runs once, but a hand-triggered
...
comment on table public.pb_potential_snapshots is
  'One row per ranked account per day per estimator, written by pb-score (DECISIONS §42). '
