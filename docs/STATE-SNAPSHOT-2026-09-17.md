...
*Point-in-time. Superseded later the same day by 0.1.4 — DECISIONS §37.*
...
*Point-in-time. Later the same day the 4 pre-16-Sep entries were filed verbatim (DECISIONS §38); the 29 boards entries wait on decision 2.*
...
*Point-in-time. The Fathom row was acted on later the same day — DECISIONS §36.*
